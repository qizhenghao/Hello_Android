 ...
 * </pre>
 */
public class CircleMenuLayoutTest1 extends ViewGroup
{
	...
	public CircleMenuLayoutTest1(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		// 无视padding
		setPadding(0, 0, 0, 0);
...
//			}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		...
		// 根据menu item的个数，计算角度
		int childConut = getChildCount()==1?0:getChildCount();
		float angleDelay = 360 / (childConut - 1);
