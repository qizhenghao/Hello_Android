...
public class ReadNotifiService extends NotificationListenerService {
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        try {
            ...
            if (sbn.getNotification().tickerText != null) {
                ...
                nMessage = sbn.getNotification().tickerText.toString() + " , " + sbn.getKey();
            ...
            Toast.makeText(ReadNotifiService.this, "不可解析的通知", Toast.LENGTH_SHORT).show();
        }
